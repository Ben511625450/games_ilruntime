...
local function UpdateUpBankerCountUI()
    self.BtnPlane.transform:Find("CustomBtn/UpBankBtn/Text"):GetComponent("Text").text = "申请人数: "..tostring(#GameData71.UpBankerList)
end

local function InitLuDan()
    self.Info.transform:Find("RecordBg/TodayJuShu"):GetComponent("Text").text = "本日局数:  "..tostring(GameData71.Allturns)
...
local function OpenOtherPlayerListUI()
    ...
    self.Info.transform:Find("PlayerList/Descrip"):GetComponent("Text").text = "当前在线人数："..tostring(num)
end
