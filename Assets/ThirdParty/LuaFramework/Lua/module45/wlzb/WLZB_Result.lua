...
function WLZB_Result.ShowResult()
    ...
    if WLZBEntry.isFreeGame then
        ...
        WLZBEntry.freeWinNum.text = WLZBEntry.ShowText(WLZBEntry.FormatNumberThousands(WLZB_Result.totalFreeGold));
    end
...
function WLZB_Result.ShowSelectFreeResultEffect()
    ...
    WLZBEntry.selectCount.text = WLZBEntry.ShowText(WLZBEntry.FreeData.nFreeCount);
    WLZBEntry.selectRate.text = WLZBEntry.ShowText(WLZBEntry.FreeData.nFreeOddIndex);
    self.showResultCallback = function()
        self.isShowSelectFreeResult = false;
        WLZBEntry.selectResult.gameObject:SetActive(false);
        self.CheckFree();
