...
function _CBalanceUI:ShowFreeTotal(_freeCount, _freeTotal)
    ...
    self.curObj:SetActive(true);
    self.freeNumber:SetNumber(_freeCount);
    self.freeValueNumber:SetNumString("g " .. _freeTotal);
    ...
    self.startStatus = {
        ...
        ReduceGameCount = function(self)
            ...
            elseif self.status == Enum_StartStatus.Auto then
                if self.autoStatus.count > 0 then
                    ...
                    self.autoStatus.atlasNumber:SetNumber(self.autoStatus.count);
            ...
            elseif self.status == Enum_StartStatus.Free then
                ...
                self.freeStatus.text.text = "剩余" .. tostring(self.freeStatus.count);    --免费
            end
        end,
        --自动开始
        ...
        InitStatus = function(self)
            ...
            elseif self.status == Enum_StartStatus.Free then
                ...
                self.freeStatus.text.text = "剩余" .. tostring(self.freeStatus.count);
            end
        end,
        --改变状态
...
function _CUILayer:_onChangeCaijin(_caijin)
    self.caijinNum:SetNumString("j " .. _caijin);
end
