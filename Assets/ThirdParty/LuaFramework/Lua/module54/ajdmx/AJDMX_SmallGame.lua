    ...
    if AJDMXEntry.SceneData.nMaxGameCount>0 then
        ...
        elseif AJDMXEntry.SceneData.nMaxGameCount==2 then
            ...
            if AJDMXEntry.SceneData.nMaxGameType[1] <=10 then
                ...
                self.maxGamePanel:GetChild(0):GetChild(index):Find("Text"):GetComponent("Text").text="免费旋转X"..AJDMXEntry.SceneData.nMaxGameType[1]
            else
                maxGameChipNum = maxGameChipNum+AJDMXEntry.SceneData.nMaxGameType[1]
                self.maxGamePanel:GetChild(0):GetChild(index):Find("Text"):GetComponent("Text").text="$"..AJDMXEntry.SceneData.nMaxGameType[1]
            end
        ...
        elseif AJDMXEntry.SceneData.nMaxGameCount==1 then
            ...
            if AJDMXEntry.SceneData.nMaxGameType[1] <=10 then
                maxGameFreecount=maxGameFreecount+AJDMXEntry.SceneData.nMaxGameType[1]
                self.maxGamePanel:GetChild(0):GetChild(index1):Find("Text"):GetComponent("Text").text="免费旋转X"..AJDMXEntry.SceneData.nMaxGameType[1]
            else
                maxGameChipNum = maxGameChipNum+AJDMXEntry.SceneData.nMaxGameType[1]
                self.maxGamePanel:GetChild(0):GetChild(index1):Find("Text"):GetComponent("Text").text="$"..AJDMXEntry.SceneData.nMaxGameType[1]
            end
            ...
            if AJDMXEntry.SceneData.nMaxGameType[2] <=10 then
                ...
                self.maxGamePanel:GetChild(0):GetChild(index2):Find("Text"):GetComponent("Text").text="免费旋转X"..AJDMXEntry.SceneData.nMaxGameType[2]
            else
                maxGameChipNum = maxGameChipNum+AJDMXEntry.SceneData.nMaxGameType[2]
                self.maxGamePanel:GetChild(0):GetChild(index2):Find("Text"):GetComponent("Text").text="$"..AJDMXEntry.SceneData.nMaxGameType[2]
            end
                    ...
                    if AJDMXEntry.smallGameData.cbPoint<=0 then
                        ...
                        if AJDMXEntry.smallGameData.cbType==0 then
                            if AJDMXEntry.smallGameData.cbFreeTime>0 then
                                ...
                                self.winFree.text="免费旋转X"..AJDMXEntry.smallGameData.cbFreeTime
                                self.winFree.gameObject:SetActive(true)
                            elseif AJDMXEntry.smallGameData.nWinGold>0 then
                                self.winGold2.text="$"..AJDMXEntry.smallGameData.nWinGold
...
function AJDMX_SmallGame.MaxGameCallBack()
    ...
    coroutine.start(function()
        if AJDMXEntry.MaxGameData.cbFreeTime>0 then
            ...
            self.maxGamePanel:GetChild(0):GetChild(clickPos-1):Find("Text"):GetComponent("Text").text="免费旋转X"..AJDMXEntry.MaxGameData.cbFreeTime
        elseif AJDMXEntry.MaxGameData.nWinGold>0 then
            maxGameChipNum=maxGameChipNum+AJDMXEntry.MaxGameData.nWinGold
            self.maxGamePanel:GetChild(0):GetChild(clickPos-1):Find("Text"):GetComponent("Text").text="$"..AJDMXEntry.MaxGameData.nWinGold
        end
        coroutine.wait(0.2)
            ...
            coroutine.start(function ()
                ...
                if CanClickNum<=0 then
                    if maxGameFreecount>0 then
                        self.winFree.text="免费旋转X"..maxGameFreecount
                        self.winFree.gameObject:SetActive(true)
                    ...
                    if maxGameChipNum>0 then
                        self.winGold2.text="$"..maxGameChipNum
                        self.winGold1.gameObject:SetActive(true)
                        self.winGold2.gameObject:SetActive(true)
                    else
                        self.winGold1.gameObject:SetActive(false)
