...
function SESX_SmallGame.ShowSmallGame()
    ...
    self.smallGameCount.text = SESXEntry.ShowText(SESXEntry.smallGameCount);
...
function SESX_SmallGame.ReStart()
    ...
    self.smallGameCount.text = SESXEntry.ShowText(SESXEntry.SmallResultData.nSmallGameConut);
