...
function MCDZZ_Result.ShowCSJLResultEffect()
    ...
    local showeffect = function()
        ...
        MCDZZEntry.freeOverTime.text=MCDZZEntry.ShowText(self.hideFreeTime)
...
function MCDZZ_Result.ShowCSJLResult()
    ...
    if self.isShowCSJLResult then
        ...
        MCDZZEntry.freeOverTime.text=MCDZZEntry.ShowText(string.format("%.1f",(self.hideFreeTime-self.timer)))
...
function MCDZZ_Result.ShowFreeEffect()
    ...
    self.showResultCallback = function()
        ...
        MCDZZEntry.reduceChipBtn.interactable = false;
        MCDZZEntry.BigBtn.interactable = false;
        MCDZZEntry.FreeCountText.text=MCDZZEntry.ShowText(tostring(MCDZZEntry.freeCount))
        MCDZZEntry.freedownTime.text=MCDZZEntry.ShowText(string.format("%.1f",self.hideFreeTime))
...
function MCDZZ_Result.HideFree()
    ...
    if self.isHideFree then
        self.timer = self.timer + Time.deltaTime;
        MCDZZEntry.freedownTime.text= MCDZZEntry.ShowText(string.format("%.1f",(self.hideFreeTime-self.timer)))
        if self.timer >= self.hideFreeTime then
            MCDZZEntry.freedownTime.text=MCDZZEntry.ShowText(0)
            --等待退出动画时长
