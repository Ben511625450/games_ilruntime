...
SI_WORD = 
{
    [SI_WORD_CODE.ENTER_DRAGON_MISSION] = "现在的龙珠等级为%d级，是否进入龙珠关卡？",
    [SI_WORD_CODE.RECHANGE_TIPS]        = "金币不足，请充值，继续向前冲",
    [SI_WORD_CODE.DRAGON_DESCRIPTION]   = "每次连线成功等分后会增加龙珠经验。\n" ..
                                            "龙珠等级越高龙珠探宝环节彩金倍率越高。\n" ..
                                            "1星龙珠：进入龙珠模式掉落1颗龙珠。\n" ..
                                            "2星龙珠：进入龙珠模式掉落2颗龙珠。\n" ..
                                            "3星龙珠：进入龙珠模式掉落3颗龙珠。\n" ..
                                            "4星龙珠：进入龙珠模式掉落4颗龙珠。\n" ..
                                            "5星龙珠：进入龙珠模式掉落5颗龙珠。",
    [SI_WORD_CODE.CLEAR_RECORD]         = "由于您7天之内未曾进入龙珠探宝，您的进度及龙珠等级已被清空，请您重新探宝。",
};
