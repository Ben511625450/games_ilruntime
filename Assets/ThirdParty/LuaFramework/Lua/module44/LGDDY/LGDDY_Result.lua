...
function LGDDY_Result.ShowResult()
    ...
    LGDDYEntry.WinNum.text = tostring(LGDDYEntry.ResultData.WinScore);
    --其他正常模式
    ...
    if LGDDYEntry.ResultData.WinScore > 0 then
        LGDDY_Line.Show();
        LGDDYEntry.WinDesc.text = "恭喜发财，喜中 <color=#F5D188FF>" .. #LGDDY_Line.showTable .. "</color> 线";
...
function LGDDY_Result.ShowBigWinEffect()
    ...
    self.timer = 0;
    self.currentRunGold = 0;
    LGDDYEntry.midWinNum.text = LGDDYEntry.ShowText("+" .. LGDDYEntry.ResultData.WinScore);
...
function LGDDY_Result.ShowSuperWinffect()
    ...
    self.timer = 0;
    self.currentRunGold = 0;
    LGDDYEntry.bigWinNum.text = LGDDYEntry.ShowText("+" .. LGDDYEntry.ResultData.WinScore);
...
function LGDDY_Result.ShowNormalEffect()
    ...
    LGDDYEntry.normalWinNum.text = LGDDYEntry.ShowText("+" .. LGDDYEntry.ResultData.WinScore);
