...
function LGDDY_SmallGame.ShowSmallGame()
    ...
    self.smallGameCount.text = LGDDYEntry.ShowText(LGDDYEntry.smallGameCount);
...
function LGDDY_SmallGame.ReStart()
    ...
    self.smallGameCount.text = LGDDYEntry.ShowText(LGDDYEntry.SmallResultData.nSmallGameConut);
