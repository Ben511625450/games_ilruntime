...
function JZSF_Result.ShowFreeEffect(isSceneData)
    ...
    JZSFEntry.EnterFreeEffect.gameObject:SetActive(true);
    JZSFEntry.EnterFreeEffectFreeCount.text=JZSFEntry.ShowText(JZSFEntry.freeCount)
    JZSFEntry.FreeResulCount.text = JZSFEntry.ShowText(JZSFEntry.freeCount);
...
function JZSF_Result.ShowSelectFreeResultEffect()
    ...
    JZSFEntry.selectCount.text = JZSFEntry.ShowText(JZSFEntry.FreeData.nFreeCount);
    JZSFEntry.selectRate.text = JZSFEntry.ShowText(JZSFEntry.FreeData.nFreeOddIndex);
    self.showResultCallback = function()
        self.isShowSelectFreeResult = false;
        JZSFEntry.selectResult.gameObject:SetActive(false);
        self.CheckFree();
