...
function SGXML_Result.ShowResult()
    ...
    SGXMLEntry.WinNum.text = tostring(SGXMLEntry.ResultData.WinScore);
    --其他正常模式
    ...
    if SGXMLEntry.ResultData.WinScore > 0 then
        SGXML_Line.Show();
        SGXMLEntry.WinDesc.text = "恭喜发财，喜中 <color=#F5D188FF>" .. #SGXML_Line.showTable .. "</color> 线";
...
function SGXML_Result.ShowFreeResultEffect()
    ...
    SGXMLEntry.FreeTotalCount.text = SGXMLEntry.ShowText(SGXMLEntry.FormatNumberThousands(SGXMLEntry.totalFreeCount));
...
function SGXML_Result.ShowBigWinEffect()
    ...
    self.timer = 0;
    self.currentRunGold = 0;
    SGXMLEntry.midWinNum.text = SGXMLEntry.ShowText("+" .. SGXMLEntry.ResultData.WinScore);
...
function SGXML_Result.ShowSuperWinffect()
    ...
    self.timer = 0;
    self.currentRunGold = 0;
    SGXMLEntry.bigWinNum.text = SGXMLEntry.ShowText("+" .. SGXMLEntry.ResultData.WinScore);
...
function SGXML_Result.ShowNormalEffect()
    ...
    SGXMLEntry.normalWinNum.text = SGXMLEntry.ShowText("+" .. SGXMLEntry.ResultData.WinScore);
