...
function SGXML_SmallGame.ShowSmallGame()
    ...
    self.smallGameCount.text = SGXMLEntry.ShowText(SGXMLEntry.smallGameCount);
...
function SGXML_SmallGame.ReStart()
    ...
    self.smallGameCount.text = SGXMLEntry.ShowText(SGXMLEntry.SmallResultData.nSmallGameConut);
