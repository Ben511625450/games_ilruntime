...
function BankPanel.UpdatePwdCodeBtn()
    ...
    local function _f()
        ...
        self.Reset_codebtn.transform:Find("Text"):GetComponent("Text").text = "60s重发"
...
function BankPanel.TimeOverTwo()
    self.Reset_codebtn.transform:Find("Text"):GetComponent("Text").text = MoveNotifyInfoClass.getcodetime .. "s重发"
