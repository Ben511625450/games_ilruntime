...
function changePassWordPanel.UpdatePwdCodeBtn()
    ...
    local function _f()
        ...
        self.CPWBXXYZMBtn.transform:Find("Text"):GetComponent("Text").text = "120s重发"
...
function changePassWordPanel.TimeOverTwo()
    self.CPWBXXYZMBtn.transform:Find("Text"):GetComponent("Text").text = MoveNotifyInfoClass.getcodetime .. "s重发"
