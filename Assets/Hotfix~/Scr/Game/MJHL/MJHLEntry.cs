...
namespace Hotfix.MJHL
{
    ...
    public class MJHLEntry : SingletonILEntity<MJHLEntry>
    {
        ...
        private void AddChipCall()
        {
            ...
            ChipNum.text = "" + GameData.CurrentChip * MJHL_DataConfig.ALLLINECOUNT;
        }
        ...
        private class InitState : State<MJHLEntry>
        {
            ...
            public override void Update()
            {
                ...
                owner.ChipNum.text =""+ owner.GameData.SceneData.nCurrenBet * MJHL_DataConfig.ALLLINECOUNT;
                owner.winNum.text = "0"; ;
                owner.AddListener();
        ...
        private class AutoRollState : State<MJHLEntry>
        {
            ...
            public override void OnEnter()
            {
                ...
                if (owner.GameData.CurrentAutoCount > 1000)
                    owner.AutoCountNum.text = ToolHelper.ShowRichText("w");
                else
