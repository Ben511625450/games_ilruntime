...
namespace Hotfix.TGG
{
    ...
    public class TGGEntry : SingletonILEntity<TGGEntry>
    {
        ...
        private void TJZ_Event_RefreshGold(long gold)
        {
            ...
            this.gold.text = ToolHelper.ShowRichText(GameData.myGold);
        }
        ...
        {
            chipNum.text = ToolHelper.ShowRichText(GameData.CurrentChip*30);
        }
        ...
        {
            WinInfoNum.text = ToolHelper.ShowRichText(GameData.ResultData.WinScore);
        }
        ...
        private void CloseGameCall()
        {
            ...
            {
                ToolHelper.PopSmallWindow("特殊模式中无法离开游戏");
            }
        }
        ...
        private void FreeGame()
        {
            ...
            freeShowCount.text = ToolHelper.ShowRichText("x"+ (12-GameData.currentFreeCount));
            if (GameData.currentFreeCount < 12) 
            { 
                TGG_Audio.Instance.PlaySound("Freex"+ GameData.currentFreeCount);
            }
            else
            {
                TGG_Audio.Instance.PlaySound("Freex12");
            }

            freeText.text = ToolHelper.ShowRichText(GameData.currentFreeCount);
            TGG_Network.Instance.StartGame();
        }
        ...
        private class EnterFreeState : State<TGGEntry>
        {
            ...
            public override void OnEnter()
            {
                ...
                owner.EnterFreeCount.text = ToolHelper.ShowRichText(owner.GameData.currentFreeCount);
                TGG_Audio.Instance.PlayBGM(TGG_Audio.FreeBGM);
        ...
        private class FreeRollState : State<TGGEntry>
        {
            ...
            public override void OnEnter()
            {
                ...
                owner.AutoStartBtn.gameObject.gameObject.SetActive(false);
                owner.freeText.gameObject.gameObject.SetActive(true);
                owner.freeText.text = ToolHelper.ShowRichText(owner.GameData.currentFreeCount);
                owner.FreeGame();
                owner.startBtn.interactable = false;
        ...
        private class FreeResultState : State<TGGEntry>
        {
            ...
            public override void OnEnter()
            {
                ...
                {
                    owner.FreeResultNum.text = ToolHelper.ShowRichText(goal);
                }).OnComplete(delegate ()
                {
