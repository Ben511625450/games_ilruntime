...
namespace Hotfix.YGBH
{
    ...
    public class YGBHEntry : SingletonILEntity<YGBHEntry>
    {
        ...
        private void YGBH_Event_RefreshGold(long gold)
        {
            ...
            this.selfGold.text = $"{GameData.myGold}";
        }
        ...
        {
            ChipNum.text = $"{GameData.CurrentChip*YGBH_DataConfig.ALLLINECOUNT}";
        }
        ...
        {
            WinNum.text =$"{GameData.ResultData.WinScore}";
        }
        ...
        private void FreeGame()
        {
            ...
            AutoStartBtn.gameObject.SetActive(false);
            FreeContent.gameObject.SetActive(true);
            FreeContent.transform.FindChildDepth("Num").GetComponent<TextMeshProUGUI>().text =ToolHelper.ShowRichText(GameData.currentFreeCount);
            //YGBH_Network.Instance.StartGame();
        }
