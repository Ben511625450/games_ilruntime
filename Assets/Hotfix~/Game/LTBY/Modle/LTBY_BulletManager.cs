...
namespace Hotfix.LTBY
{
    ...
    public class BulletClass
    {
        ...
        public virtual void OnCreate(int _chairId, int _id, int _level, Vector3 pos, float angles)
        {
            ...
            this.id = _id;
            this.level = _level;
            this.bulletName = $"LTBY_Bullet{this.level}";
    ...
    public class BulletDrillClass : BulletClass
    {
        ...
        public override void OnFinish()
        {
            ...
            sequence.Append(bullet.DOBlendableRotateBy(new Vector3(0, 0, 1080), 3));
            Sequence sequence1 = DOTween.Sequence();
            sequence.Insert(0, sequence1);
            sequence1.Append(bullet.DOBlendableScaleBy(new Vector2(1, 1), 0.5f));
            sequence1.Append(bullet.DOBlendableScaleBy(new Vector2(-1, -1), 0.5f));
            sequence1.SetLoops(3);
            sequence.OnComplete(CreateExplosion);
    ...
    public class BulletWaterSpoutClass : BulletClass
    {
        ...
        public void SetRageSpout(bool flag)
        {
        }

        public void SetWiderSpout(bool flag)
        {
        }
