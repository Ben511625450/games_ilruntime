        ...
        private class UpLevelState : State<TJZ_Result>
        {
            ...
            public override void OnEnter()
            {
                ...
                if (TJZEntry.Instance.GameData.isFreeGame)
                {
                    ...
                    else if (TJZEntry.Instance.GameData.UpLevel == 6 && !TJZEntry.Instance.FreeMZ.GetChild(0).gameObject.activeSelf)
                    {
                        owner.UpLevel2.gameObject.SetActive(true);
                    }
                    else if (TJZEntry.Instance.GameData.UpLevel == 10 && !TJZEntry.Instance.FreeChe.GetChild(0).gameObject.activeSelf)
                    {
