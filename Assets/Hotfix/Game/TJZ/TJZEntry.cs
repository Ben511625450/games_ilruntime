...
namespace Hotfix.TJZ
{
    ...
    public class TJZEntry : SingletonILEntity<TJZEntry>
    {
        ...
        {
            chipNum.text = $"（25线x{GameData.CurrentChip}）";
            allChipInfo.text =ToolHelper.ShowRichText(GameData.CurrentChip*TJZ_DataConfig.ALLLINECOUNT);
        }
        ...
        private void TJZ_Event_ShowResult()
        {
            ...
            WinInfoNum.text = ToolHelper.ShowRichText(winGold);
        }
        ...
        private class AutoRollState : State<TJZEntry>
        {
            ...
            public override void OnEnter()
            {
                ...
                if (owner.GameData.CurrentAutoCount<1000)
                {
                    owner.closeAutoBtn.transform.FindChildDepth<TextMeshProUGUI>("Text").text = ToolHelper.ShowRichText(owner.GameData.CurrentAutoCount);
                }
                owner.Freestate.gameObject.SetActive(false);
        ...
        private class EnterFreeState : State<TJZEntry>
        {
            ...
            public override void OnEnter()
            {
                ...
                owner.FreestateNum.text = ToolHelper.ShowRichText(owner.GameData.CurrentFreeCount);
                TJZ_Audio.Instance.PlayBGM(TJZ_Audio.FreeBGM);
            }
