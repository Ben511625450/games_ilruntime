...
namespace Hotfix.LTBY
{
    public class LTBY_Messagebox : LTBY_ViewBase
    {
        ...
        protected override void OnCreate(params object[] args)
        {
            ...
            AddClick(board.FindChildDepth("Top/BtnBack"), delegate ()
            {
                OnBtnBack();
            });
            EnterAction();
        ...
        public void SetBoardProperty(float x, float y, float w, float h)
        {
        ...
        public virtual void EnterAction()
        {
            ...
            board?.DOScale(1, 0.3f).SetEase(Ease.OutBack).OnComplete( ()=>
            {
                actionPlaying = false;
            });
        }
        ...
        public virtual void ExitAction()
        {
            if (actionPlaying) return;
            actionPlaying = true;
            board?.DOScale(0, 0.3f).SetEase(Ease.InBack).OnComplete( ()=>
            {
                Destroy();
            });
