...
namespace Hotfix.LTBY
{
    public class LTBY_DataConfig
    {
        ...
        {
            new GunInfoData() {gun_level = 1, ratio_min = 100, ratio_max = 1000, enable = true},
            new GunInfoData() {gun_level = 2, ratio_min = 200, ratio_max = 2000, enable = true},
            new GunInfoData() {gun_level = 3, ratio_min = 300, ratio_max = 3000, enable = true},
            new GunInfoData() {gun_level = 4, ratio_min = 400, ratio_max = 4000, enable = true},
            new GunInfoData() {gun_level = 5, ratio_min = 500, ratio_max = 5000, enable = true},
            new GunInfoData() {gun_level = 6, ratio_min = 600, ratio_max = 6000, enable = true},
            new GunInfoData() {gun_level = 7, ratio_min =700, ratio_max = 7000, enable = true},
            new GunInfoData() {gun_level = 8, ratio_min = 800, ratio_max = 8000, enable = true},
            new GunInfoData() {gun_level = 9, ratio_min = 900, ratio_max = 9000, enable = true},
            new GunInfoData() {gun_level = 10, ratio_min = 1000, ratio_max = 10000, enable = true}
        };
