		...
		private void Update()
		{
			...
			if (!flag)
			{
				...
				if (!flag2)
				{
                    ...
                    bool flag3 = !this.www.isDone&& this.time < (float)this.outTime;
					if (!flag3)
					{
                        ...
                        bool flag4 = this.www.isDone && !this.www.isNetworkError && !this.www.isHttpError&& this.www.downloadHandler.text.Contains(AppConst.AuthCode);
