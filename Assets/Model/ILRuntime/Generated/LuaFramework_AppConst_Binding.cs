...
namespace ILRuntime.Runtime.Generated
{
    unsafe class LuaFramework_AppConst_Binding
    {
        ...
        static StackObject* CopyToStack_csConfiger_0(ref object o, ILIntepreter __intp, StackObject* __ret, IList<object> __mStack)
        {
        ...
        static StackObject* AssignFromStack_csConfiger_0(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, IList<object> __mStack)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
        ...
        static StackObject* CopyToStack_gameValueConfiger_1(ref object o, ILIntepreter __intp, StackObject* __ret, IList<object> __mStack)
        {
        ...
        static StackObject* AssignFromStack_gameValueConfiger_1(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, IList<object> __mStack)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
        ...
        static StackObject* CopyToStack_WebUrl_2(ref object o, ILIntepreter __intp, StackObject* __ret, IList<object> __mStack)
        {
        ...
        static StackObject* AssignFromStack_WebUrl_2(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, IList<object> __mStack)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
        ...
        static StackObject* CopyToStack_valueConfiger_3(ref object o, ILIntepreter __intp, StackObject* __ret, IList<object> __mStack)
        {
        ...
        static StackObject* AssignFromStack_valueConfiger_3(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, IList<object> __mStack)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
