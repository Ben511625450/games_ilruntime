...
namespace ILRuntime.Runtime.Generated
{
    unsafe class LuaFramework_UnityWebPacket_Binding
    {
        ...
        static StackObject* CopyToStack_urlPath_0(ref object o, ILIntepreter __intp, StackObject* __ret, IList<object> __mStack)
        {
        ...
        static StackObject* AssignFromStack_urlPath_0(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, IList<object> __mStack)
        {
        ...
        static StackObject* CopyToStack_localPath_1(ref object o, ILIntepreter __intp, StackObject* __ret, IList<object> __mStack)
        {
        ...
        static StackObject* AssignFromStack_localPath_1(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, IList<object> __mStack)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
        ...
        static StackObject* CopyToStack_size_2(ref object o, ILIntepreter __intp, StackObject* __ret, IList<object> __mStack)
        {
        ...
        static StackObject* AssignFromStack_size_2(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, IList<object> __mStack)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
        ...
        static StackObject* CopyToStack_func_3(ref object o, ILIntepreter __intp, StackObject* __ret, IList<object> __mStack)
        {
        ...
        static StackObject* AssignFromStack_func_3(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, IList<object> __mStack)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
